...
# Itens do Contrato 2021/26 (códigos BEC do contrato reajustado 2026).
# codigo = SG### (sequencial, único); bec = código BEC do contrato reajustado 2026,
# sem hífen (vai em Item.natureza); vazio nos itens ainda sem código BEC informado;
# quantidade = quantidade contratada; preco = valor unitário.
ITENS = [
    # Banners e Roll Up
    {'cat': 'graficos_banners', 'codigo': 'SG001', 'bec': '228990', 'qtd': 72, 'preco': 90.00,
    ...
    {'cat': 'graficos_banners', 'codigo': 'SG002', 'bec': '229008', 'qtd': 72, 'preco': 100.00,
    ...
    {'cat': 'graficos_banners', 'codigo': 'SG003', 'bec': '229016', 'qtd': 72, 'preco': 120.00,
    ...
    {'cat': 'graficos_banners', 'codigo': 'SG039', 'bec': '', 'qtd': 72, 'preco': 260.00,
    ...
    {'cat': 'graficos_banners', 'codigo': 'SG040', 'bec': '', 'qtd': 72, 'preco': 300.00,
    ...
    {'cat': 'graficos_publicacoes', 'codigo': 'SG008', 'bec': '229733', 'qtd': 1440, 'preco': 15.00,
    ...
    {'cat': 'graficos_publicacoes', 'codigo': 'SG009', 'bec': '229741', 'qtd': 1440, 'preco': 25.00,
     'descricao': 'Cartilha/book formato 29,7cm x 21cm, 96 páginas, papel couche 115gr, impressão 4 x 4 cores, capa dura'},
    {'cat': 'graficos_publicacoes', 'codigo': 'SG014', 'bec': '229911', 'qtd': 2880, 'preco': 7.00,
    ...
    {'cat': 'graficos_publicacoes', 'codigo': 'SG015', 'bec': '229920', 'qtd': 2880, 'preco': 7.00,
    ...
    {'cat': 'graficos_publicacoes', 'codigo': 'SG053', 'bec': '', 'qtd': 288, 'preco': 138.00,
    ...
    {'cat': 'graficos_impressoes', 'codigo': 'SG037', 'bec': '230464', 'qtd': 72, 'preco': 22.00,
    ...
    {'cat': 'graficos_impressoes', 'codigo': 'SG038', 'bec': '230472', 'qtd': 72, 'preco': 13.00,
    ...
    {'cat': 'graficos_impressoes', 'codigo': 'SG043', 'bec': '', 'qtd': 144, 'preco': 50.00,
    ...
    {'cat': 'graficos_impressoes', 'codigo': 'SG044', 'bec': '', 'qtd': 144, 'preco': 35.00,
    ...
    {'cat': 'graficos_impressoes', 'codigo': 'SG045', 'bec': '', 'qtd': 144, 'preco': 25.00,
    ...
    {'cat': 'graficos_impressoes', 'codigo': 'SG049', 'bec': '', 'qtd': 288, 'preco': 4.50,
    ...
    {'cat': 'graficos_acabamentos', 'codigo': 'SG042', 'bec': '', 'qtd': 2880, 'preco': 5.00,
     'descricao': 'Bloco de notas A5 (14,8 x 21 cm) - papel offset 75 g/m² ou 90 g/m², 1x0 / 4x0 cores, 30 folhas, acabamento refile'},
    {'cat': 'graficos_acabamentos', 'codigo': 'SG047', 'bec': '', 'qtd': 144, 'preco': 3.00,
    ...
    {'cat': 'graficos_acabamentos', 'codigo': 'SG048', 'bec': '', 'qtd': 144, 'preco': 4.50,
        ...
        for item_info in ITENS:
            ...
            if not item:
                item = Item(
                    ...
                    unidade='UNIDADE',
                    natureza=item_info['bec'] or None,  # código BEC do contrato
                )
                db.session.add(item)
                db.session.flush()
                ...
                criados += 1
                print(f"  Item {item_info['codigo']} (BEC {item_info['bec'] or '-'}): {item_info['descricao'][:60]}...")
            else:
