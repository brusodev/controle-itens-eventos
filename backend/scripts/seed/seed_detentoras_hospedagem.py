#!/usr/bin/env python3
"""Script para popular detentoras do módulo de Hospedagem"""
...
def seed_detentoras_hospedagem():
    with app.app_context():
        print("🏨 Populando detentoras do módulo de Hospedagem...")
        
        # Dados REAIS das detentoras para Hospedagem (extraídos do banco local)
        detentoras_data = [
            {
                'nome': 'Hotel',
                'cnpj': '23.909.999/0001-89',
            ...
            {
                'nome': 'Hotel Hibis',
                'cnpj': '98.979.879/7789-78',
                'contrato_num': '014/DA/2026',
                'data_assinatura': '2026-02-19',
                'prazo_vigencia': '12 MESES',
                'servico': 'Hospedagem',
                'grupo': 2,
                'modulo': 'hospedagem'
        ...
        for det_info in detentoras_data:
            ...
            det = Detentora.query.filter_by(grupo=det_info['grupo'], modulo='hospedagem', ativo=True).first()
            if not det:
        ...
        db.session.commit()
        print("\n✅ Seed de detentoras de Hospedagem concluído!")
